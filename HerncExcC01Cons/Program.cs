using HerncExcC01Lib;

namespace HerncExcC01Cons
{
    internal class Program
    {
        ...
        static void Test1_ATeamOfTwoPlayerTop_WithTwoPlayer_AndTryAddThirdPlayer() {
            ...
            //---New third Player
            Person newPlayer = new Player(898989, "paola", 2, 200);
            bool addSucess = team + (Player)newPlayer; //PREGUNTAR CASTEO ->llamo operador sobrecargado +
